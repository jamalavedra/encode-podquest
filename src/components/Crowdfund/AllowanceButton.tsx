...
const AllowanceButton: FC<Props> = ({ title = 'Allow', module, allowed, setAllowed }) => {
	...
	return allowed ? (
		<Button
			variant="warning"
			icon={queryLoading || transactionLoading || waitLoading ? <Spinner /> : <MinusIcon className="w-4 h-4" />}
					...
					<WarningMessage
						...
						message={
							<div className="leading-6">
								Please make sure that if you allow this module you will automatically be detected with
								the amount if you <b>collect</b>,<b> fund</b> and <b>super follow</b>.
							</div>
						}
					/>
					<Button
						...
						onClick={() => handleAllowance(module.currency, '10000000000', module.module)}
					>
						{title}
					</Button>
				</div>
