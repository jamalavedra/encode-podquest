	...
	if (profile?.followModule?.__typename == 'RevertFollowModuleSettings') {
		return (
			<button
				...
				className="px-3 py-2 bg-gray-300 uppercase text-red-50 font-medium text-sm rounded-md cursor-not-allowed"
			>
				Follow
			</button>
		)
	...
	if (profile?.followModule?.__typename == 'FeeFollowModuleSettings') {
		return (
			<button
				...
				className="px-3 py-2 bg-gray-800 uppercase text-red-50 font-medium text-sm rounded-md"
			>
